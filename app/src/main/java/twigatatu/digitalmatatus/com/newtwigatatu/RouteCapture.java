...
import twigatatu.digitalmatatus.com.newtwigatatu.TransitWandProtos.Upload.Route.Point;
import twigatatu.digitalmatatus.com.newtwigatatu.TransitWandProtos.Upload.Route.Stop;
...
public class RouteCapture {
    ...
    public static RouteCapture deseralize(Upload.Route r, Context context) {
    ...
    public static JSONObject jsonify(Upload.Route r) {
    ...
    public static JSONObject jsonify(Upload.Route r,Context context) {
